...
// even numbers from 1 to 100 [2,4..100]

// every 10th element from 0 to 100[0,10..100]
...
seqCheckAux [] = [True]
seqCheckAux [x] = [isEven x]
seqCheckAux list = [isEven(hd list)] ++ [isOdd(hd(tl list))] ++ seqCheckAux (tl(tl list))

seqCheck list = and (seqCheckAux list)
...
isPali num = numToList num == reverse (numToList num)
